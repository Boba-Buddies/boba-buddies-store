...
function Contact() {
  ...
  const [newEmail, setNewEmail] = useState({} as NewEmail)
  ...
  return (
    <>
      <form className='flex flex-col'>
        ...
        <input className='mt-2 ml-2 border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500' type="text" name='title' onChange={handleChange} required />
        <label htmlFor="description" className='mt-8 ml-2'>Message(description)</label>
        <input className='mt-6 ml-2 h-28 border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500' name="description" onChange={handleChange} required />
