exports.seed = async function (knex) {
  await knex('users').insert([
    ...
    {
      auth0_id: 'auth0|rigelle-test',
      first_name: 'Rigelle',
      last_name: 'Cruz',
      user_name: 'rigelle_cruz',
      phone_number: '64 27 9990000',
      address: 'some place',
      city: 'Auckland',
      country: 'New Zealand',
      zip_code: '1999',
      email_address: 'rigelle@lemon.com',
      created_at: '2023-07-12 9:55:00',
      is_admin: false,
    },
    {
      auth0_id: 'auth0|lemon-test',
      first_name: 'Lemon',
      last_name: 'Zest',
      user_name: 'lemonia',
      phone_number: '0800 83 83 83',
      address: 'some place in lemon land',
      city: 'Auckland',
      country: 'New Zealand',
      zip_code: '0000',
      email_address: 'lemonia@lemon.com',
      created_at: '2023-09-12 9:55:00',
      is_admin: false,
    },
  ])
}
